  ...
  Widget build(BuildContext context) {
    return CardWithShadow(child: Column(
      children: [
        Row(
          children: [
            CustomSvgBuilder(path: AppAssets.svgsSendIcon, width: 24, height: 24, fit: BoxFit.scaleDown,),
            10.horizontalSpace,
            Text(context.infoContact, style: context.textStyles.font16MediumSecondaryColor,),
          ],
        ),
        14.verticalSizedBox,
